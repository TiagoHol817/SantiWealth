...
export default function DebtWidget({ goal, avgMonthlyPayment = 0 }: Props) {
  ...
  return (
    <div className="card p-6 relative overflow-hidden">
      ...
      {/* Barra de progreso */}
      <div className="rounded-full overflow-hidden mb-3" style={{ background: 'rgba(255,255,255,0.06)', height: '12px' }}>
      ...
      <div style={{ borderTop: '1px solid rgba(255,255,255,0.05)', paddingTop: '16px' }}>
        ...
        <div className="flex gap-2 mb-4">
          {scenarios.map((s, i) => (
            <button key={s.label}
              ...
              style={{
                backgroundColor: scenarioIdx === i ? s.color + '25' : 'rgba(0,0,0,0.25)',
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="rounded-xl p-3" style={{ background: 'rgba(0,0,0,0.28)' }}>
