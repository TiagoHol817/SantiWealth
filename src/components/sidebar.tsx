...
// ── Tooltip wrapper: only activates when sidebar is collapsed ─────────────
function NavTooltip({
  label, isCollapsed, children,
}: { label: string; isCollapsed: boolean; children: React.ReactNode }) {
...
export default function Sidebar({ isCollapsed, onToggle }: SidebarProps) {
  ...
  // Notification panel left offset changes with collapsed state
  const panelLeft = isCollapsed ? '80px' : '270px'
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className={`flex items-center ${isCollapsed ? 'justify-center' : 'justify-between'} mb-3`}>
          <div className="flex items-center gap-3 min-w-0">
            ...
            {/* Brand text — slides out when collapsed */}
            <div
              style={{
                overflow: 'hidden',
            ...
            >
              <WealtHostBrand size="md" />
              <p style={{ color: '#4b5563', fontSize: '11px' }}>Personal Finance</p>
            </div>
          </div>

          {/* Utility icons — only when expanded */}
          {!isCollapsed && (
            <div className="flex items-center gap-1 flex-shrink-0">
                  ...
                  <>
                    ...
                    <div
                      ...
                      style={{
                        ...
                        width: '320px', top: '70px', left: panelLeft,
              ...
              <button onClick={toggle}
                className="w-8 h-8 rounded-lg flex items-center justify-center transition-all hover:bg-white/10"
                style={{ color: visible ? '#4b5563' : '#10b981' }}>
      ...
      >
        ...
        {/* Version tag — hidden when collapsed */}
        <p
