...
export const config = {
  matcher: [
     ...
     * - favicon.ico
     * - auth/callback and api/auth/callback (Supabase PKCE exchange — must be public)
     * - common static asset extensions
     */
    '/((?!_next/static|_next/image|favicon\\.ico|auth/callback|api/auth/callback|.*\\.(?:svg|png|jpg|jpeg|gif|webp|ico|woff2?|ttf|otf|eot)$).*)',
  ],
}
